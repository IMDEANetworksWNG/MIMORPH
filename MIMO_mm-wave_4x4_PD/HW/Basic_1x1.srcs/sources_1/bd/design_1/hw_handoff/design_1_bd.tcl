...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net adc_tile0_o_INC_BP_2 [get_bd_ports o_INC_BP_0] [get_bd_ports o_INC_BP_1] [get_bd_ports o_INC_BP_2] [get_bd_ports o_INC_BP_3] [get_bd_pins SPB_blocks/o_INC_BP_0]
  connect_bd_net -net adc_tile0_o_RST_BP_2 [get_bd_ports o_RST_BP_0] [get_bd_ports o_RST_BP_1] [get_bd_ports o_RST_BP_2] [get_bd_ports o_RST_BP_3] [get_bd_pins SPB_blocks/o_RST_BP_0]
  connect_bd_net -net adc_tile0_o_RTN_BP_2 [get_bd_ports o_RTN_BP_0] [get_bd_ports o_RTN_BP_1] [get_bd_ports o_RTN_BP_2] [get_bd_ports o_RTN_BP_3] [get_bd_pins SPB_blocks/o_RTN_BP_2]
