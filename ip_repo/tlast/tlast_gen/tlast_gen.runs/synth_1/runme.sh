...
HD_PWD='/home/rafael/Documentos/RFSoc/ip_repo/tlast/tlast_gen/tlast_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tlast_gen_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tlast_gen_v1_0.tcl
