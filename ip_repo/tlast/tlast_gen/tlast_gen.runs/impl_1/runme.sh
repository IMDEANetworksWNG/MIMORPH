...
HD_PWD='/home/rafael/Documentos/RFSoc/ip_repo/tlast/tlast_gen/tlast_gen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlast_gen_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlast_gen_v1_0.tcl -notrace
