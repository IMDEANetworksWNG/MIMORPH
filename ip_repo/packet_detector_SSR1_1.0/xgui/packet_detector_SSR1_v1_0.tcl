...
proc update_MODELPARAM_VALUE.C_M01_AXIS_TDATA_WIDTH { MODELPARAM_VALUE.C_M01_AXIS_TDATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "C_M01_AXIS_TDATA_WIDTH". Setting updated value from the model parameter.
set_property value 16 ${MODELPARAM_VALUE.C_M01_AXIS_TDATA_WIDTH}
}
...
set_property value 16 ${MODELPARAM_VALUE.C_M00_AXIS_TDATA_WIDTH}
}
...
proc update_MODELPARAM_VALUE.C_M02_AXIS_TDATA_WIDTH { MODELPARAM_VALUE.C_M02_AXIS_TDATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "C_M02_AXIS_TDATA_WIDTH". Setting updated value from the model parameter.
set_property value 80 ${MODELPARAM_VALUE.C_M02_AXIS_TDATA_WIDTH}
}
...
set_property value 16 ${MODELPARAM_VALUE.C_S00_AXIS_TDATA_WIDTH}
}

proc update_MODELPARAM_VALUE.C_S01_AXIS_TDATA_WIDTH { MODELPARAM_VALUE.C_S01_AXIS_TDATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "C_S01_AXIS_TDATA_WIDTH". Setting updated value from the model parameter.
set_property value 16 ${MODELPARAM_VALUE.C_S01_AXIS_TDATA_WIDTH}
}
