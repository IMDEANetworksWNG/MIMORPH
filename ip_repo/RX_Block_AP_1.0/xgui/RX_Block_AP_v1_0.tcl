...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "STREAM" -parent ${Page_0}


}

proc update_PARAM_VALUE.STREAM { PARAM_VALUE.STREAM } {
	# Procedure called to update STREAM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.STREAM { PARAM_VALUE.STREAM } {
	# Procedure called to validate STREAM
	return true
}
...
proc update_MODELPARAM_VALUE.STREAM { MODELPARAM_VALUE.STREAM PARAM_VALUE.STREAM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.STREAM}] ${MODELPARAM_VALUE.STREAM}
}
