...
int configPacketDetector(convData_t* cmdArrgs){
	...
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_0_S00_AXI_BASEADDR, packet);
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_1_S00_AXI_BASEADDR, packet);
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_2_S00_AXI_BASEADDR, packet);
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_3_S00_AXI_BASEADDR, packet);

	usleep(10);

	packet=noiseTh;
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_0_S00_AXI_BASEADDR+0x04, packet);
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_1_S00_AXI_BASEADDR+0x04, packet);
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_2_S00_AXI_BASEADDR+0x04, packet);
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_3_S00_AXI_BASEADDR+0x04, packet);

	usleep(10);

	packet=highTime;
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_0_S00_AXI_BASEADDR+0x08, packet);
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_1_S00_AXI_BASEADDR+0x08, packet);
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_2_S00_AXI_BASEADDR+0x08, packet);
	Xil_Out32(XPAR_SPB_BLOCKS_PACKET_DETECTOR_11AD_3_S00_AXI_BASEADDR+0x08, packet);
