...
extern int SPIwriteTCP(convData_t* cmdArrgs);
extern void experimentLoop(convData_t* cmdArrgs);
...
CMDSTRUCT cmdtab[] = {
	...
	*captData},
	...
	{"configTXBlock","<Type> <PDth> <Type>", "uuu", *configTXBlock},
	{"configRXBlock","<Type> <PDth> <Type>", "uuuu", *configRXBlock},
	{"SPIwriteTCP","<Type>", "uuuu", *SPIwriteTCP},
	{"experimentLoop","", "", *experimentLoop},
