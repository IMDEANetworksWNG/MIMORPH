...
#ifdef MTS_4x4
#ifdef BITS5
#define RATE_CONV0	XPAR_SPB_BLOCKS_STREAM_0_BIT_SLICER_0_S00_AXI_BASEADDR
#define RATE_CONV1	XPAR_SPB_BLOCKS_STREAM_1_BIT_SLICER_0_S00_AXI_BASEADDR
#define RATE_CONV2	XPAR_SPB_BLOCKS_STREAM_2_BIT_SLICER_0_S00_AXI_BASEADDR
#define RATE_CONV3	XPAR_SPB_BLOCKS_STREAM_3_BIT_SLICER_0_S00_AXI_BASEADDR
#define RATE_CONV0	0
#define RATE_CONV1	0
#define RATE_CONV2	0
#define RATE_CONV3	0
