...
int cnt=0;
#if defined (U_WAVE)
unsigned int tile_tlast_addr []={XPAR_ADC_TILE0_TLAST_GEN_V1_0_0_BASEADDR,0,XPAR_ADC_TILE2_TLAST_GEN_V1_0_0_BASEADDR,XPAR_ADC_TILE3_TLAST_GEN_V1_0_0_BASEADDR};
...
int configRXBlock(convData_t* cmdArrgs){
	...
	Xil_Out32(RX_Block_AP[1][stream], packet);
...
int configPacketCounter(convData_t* cmdArrgs){
	...
	Xil_Out32(XPAR_ADC_TILE2_PACKET_COUNTER_0_S00_AXI_BASEADDR, packet);
#if defined (MTS_2x2)
	...
	Xil_Out32(XPAR_ADC_TILE3_PACKET_COUNTER_0_S00_AXI_BASEADDR, packet);
#ifndef U_WAVE
...
int configPacketDetector(convData_t* cmdArrgs){
	...
	u32 packet = (selOut)<<31 | (nCount)<<4 | (PDth);
...
#ifdef U_WAVE
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR, packet);
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR, packet);
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR, packet);
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR, packet);
#endif
...
#ifdef U_WAVE
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR+0x04, packet);
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR+0x04, packet);
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR+0x04, packet);
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR+0x04, packet);
#endif
...
#ifdef U_WAVE
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR+0x08, packet);
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR+0x08, packet);
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR+0x08, packet);
	Xil_Out32(XPAR_RX_CHANNELIZER_PACKET_DETECTOR_SSR1_0_S00_AXI_BASEADDR+0x08, packet);
#endif
