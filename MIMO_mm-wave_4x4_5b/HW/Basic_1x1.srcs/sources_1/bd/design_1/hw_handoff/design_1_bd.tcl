...
proc create_hier_cell_SPB_blocks { parentCell nameHier } {
  ...
  # Create instance: bit_slicer_0, and set properties
  set bit_slicer_0 [ create_bd_cell -type ip -vlnv user.org:user:bit_slicer:1.0 bit_slicer_0 ]
  set_property -dict [ list \
   CONFIG.sampleSize {5} \
 ] $bit_slicer_0

  # Create instance: bit_slicer_1, and set properties
  set bit_slicer_1 [ create_bd_cell -type ip -vlnv user.org:user:bit_slicer:1.0 bit_slicer_1 ]

  # Create instance: bit_slicer_2, and set properties
  set bit_slicer_2 [ create_bd_cell -type ip -vlnv user.org:user:bit_slicer:1.0 bit_slicer_2 ]

  # Create instance: bit_slicer_3, and set properties
  set bit_slicer_3 [ create_bd_cell -type ip -vlnv user.org:user:bit_slicer:1.0 bit_slicer_3 ]

  # Create instance: control_switch0
  create_hier_cell_control_switch0 $hier_obj control_switch0

  # Create instance: sample_concatenation_0, and set properties
  set sample_concatenation_0 [ create_bd_cell -type ip -vlnv user.org:user:sample_concatenation:1.0 sample_concatenation_0 ]
  set_property -dict [ list \
   CONFIG.sampleSize {5} \
 ] $sample_concatenation_0

  # Create instance: sample_concatenation_1, and set properties
  set sample_concatenation_1 [ create_bd_cell -type ip -vlnv user.org:user:sample_concatenation:1.0 sample_concatenation_1 ]

  # Create instance: sample_concatenation_2, and set properties
  set sample_concatenation_2 [ create_bd_cell -type ip -vlnv user.org:user:sample_concatenation:1.0 sample_concatenation_2 ]

  # Create instance: sample_concatenation_3, and set properties
  set sample_concatenation_3 [ create_bd_cell -type ip -vlnv user.org:user:sample_concatenation:1.0 sample_concatenation_3 ]

  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI2_1 [get_bd_intf_pins S00_AXI2] [get_bd_intf_pins bit_slicer_0/S00_AXI]
  connect_bd_intf_net -intf_net S00_AXI3_1 [get_bd_intf_pins S00_AXI3] [get_bd_intf_pins bit_slicer_1/S00_AXI]
  connect_bd_intf_net -intf_net S00_AXI5_1 [get_bd_intf_pins S00_AXI5] [get_bd_intf_pins bit_slicer_2/S00_AXI]
  connect_bd_intf_net -intf_net S00_AXIS1_1 [get_bd_intf_pins S00_AXIS1] [get_bd_intf_pins bit_slicer_0/S00_AXIS]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins bit_slicer_3/S00_AXI]
  connect_bd_intf_net -intf_net S01_AXIS1_1 [get_bd_intf_pins S01_AXIS1] [get_bd_intf_pins bit_slicer_0/S01_AXIS]
  connect_bd_intf_net -intf_net S02_AXIS_1 [get_bd_intf_pins S02_AXIS] [get_bd_intf_pins bit_slicer_1/S00_AXIS]
  connect_bd_intf_net -intf_net S03_AXIS_1 [get_bd_intf_pins S03_AXIS] [get_bd_intf_pins bit_slicer_1/S01_AXIS]
  connect_bd_intf_net -intf_net S04_AXIS_1 [get_bd_intf_pins S04_AXIS] [get_bd_intf_pins bit_slicer_2/S00_AXIS]
  connect_bd_intf_net -intf_net S05_AXIS_1 [get_bd_intf_pins S05_AXIS] [get_bd_intf_pins bit_slicer_2/S01_AXIS]
  connect_bd_intf_net -intf_net S06_AXIS_1 [get_bd_intf_pins S06_AXIS] [get_bd_intf_pins bit_slicer_3/S00_AXIS]
  connect_bd_intf_net -intf_net S07_AXIS_1 [get_bd_intf_pins S07_AXIS] [get_bd_intf_pins bit_slicer_3/S01_AXIS]
  connect_bd_intf_net -intf_net bit_slicer_0_M00_AXIS [get_bd_intf_pins bit_slicer_0/M00_AXIS] [get_bd_intf_pins sample_concatenation_0/S00_AXIS]
  connect_bd_intf_net -intf_net bit_slicer_0_M01_AXIS [get_bd_intf_pins bit_slicer_0/M01_AXIS] [get_bd_intf_pins sample_concatenation_0/S01_AXIS]
  connect_bd_intf_net -intf_net bit_slicer_1_M00_AXIS [get_bd_intf_pins bit_slicer_1/M00_AXIS] [get_bd_intf_pins sample_concatenation_1/S00_AXIS]
  connect_bd_intf_net -intf_net bit_slicer_1_M01_AXIS [get_bd_intf_pins bit_slicer_1/M01_AXIS] [get_bd_intf_pins sample_concatenation_1/S01_AXIS]
  connect_bd_intf_net -intf_net bit_slicer_2_M00_AXIS [get_bd_intf_pins bit_slicer_2/M00_AXIS] [get_bd_intf_pins sample_concatenation_2/S00_AXIS]
  connect_bd_intf_net -intf_net bit_slicer_2_M01_AXIS [get_bd_intf_pins bit_slicer_2/M01_AXIS] [get_bd_intf_pins sample_concatenation_2/S01_AXIS]
  connect_bd_intf_net -intf_net bit_slicer_3_M00_AXIS [get_bd_intf_pins bit_slicer_3/M00_AXIS] [get_bd_intf_pins sample_concatenation_3/S00_AXIS]
  connect_bd_intf_net -intf_net bit_slicer_3_M01_AXIS [get_bd_intf_pins bit_slicer_3/M01_AXIS] [get_bd_intf_pins sample_concatenation_3/S01_AXIS]
  connect_bd_intf_net -intf_net sample_concatenation_0_M00_AXIS [get_bd_intf_pins M00_AXIS2] [get_bd_intf_pins sample_concatenation_0/M00_AXIS]
  connect_bd_intf_net -intf_net sample_concatenation_0_M01_AXIS [get_bd_intf_pins M01_AXIS2] [get_bd_intf_pins sample_concatenation_0/M01_AXIS]
  connect_bd_intf_net -intf_net sample_concatenation_1_M00_AXIS [get_bd_intf_pins M00_AXIS3] [get_bd_intf_pins sample_concatenation_1/M00_AXIS]
  connect_bd_intf_net -intf_net sample_concatenation_1_M01_AXIS [get_bd_intf_pins M01_AXIS3] [get_bd_intf_pins sample_concatenation_1/M01_AXIS]
  connect_bd_intf_net -intf_net sample_concatenation_2_M00_AXIS [get_bd_intf_pins M00_AXIS1] [get_bd_intf_pins sample_concatenation_2/M00_AXIS]
  connect_bd_intf_net -intf_net sample_concatenation_2_M01_AXIS [get_bd_intf_pins M01_AXIS1] [get_bd_intf_pins sample_concatenation_2/M01_AXIS]
  connect_bd_intf_net -intf_net sample_concatenation_3_M00_AXIS [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins sample_concatenation_3/M00_AXIS]
  connect_bd_intf_net -intf_net sample_concatenation_3_M01_AXIS [get_bd_intf_pins M01_AXIS] [get_bd_intf_pins sample_concatenation_3/M01_AXIS]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins bit_slicer_0/aclk] [get_bd_pins bit_slicer_1/aclk] [get_bd_pins bit_slicer_2/aclk] [get_bd_pins bit_slicer_3/aclk] [get_bd_pins sample_concatenation_0/aclk] [get_bd_pins sample_concatenation_1/aclk] [get_bd_pins sample_concatenation_2/aclk] [get_bd_pins sample_concatenation_3/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins adc_clk_soft_aresetn] [get_bd_pins bit_slicer_0/aresetn] [get_bd_pins bit_slicer_1/aresetn] [get_bd_pins bit_slicer_2/aresetn] [get_bd_pins bit_slicer_3/aresetn] [get_bd_pins sample_concatenation_0/aresetn] [get_bd_pins sample_concatenation_1/aresetn] [get_bd_pins sample_concatenation_2/aresetn] [get_bd_pins sample_concatenation_3/aresetn]
  connect_bd_net -net control_switch0_tvalid_o [get_bd_pins control_switch0/tvalid_o] [get_bd_pins sample_concatenation_0/s00_axis_tvalid] [get_bd_pins sample_concatenation_0/s01_axis_tvalid] [get_bd_pins sample_concatenation_1/s00_axis_tvalid] [get_bd_pins sample_concatenation_1/s01_axis_tvalid] [get_bd_pins sample_concatenation_2/s00_axis_tvalid] [get_bd_pins sample_concatenation_2/s01_axis_tvalid] [get_bd_pins sample_concatenation_3/s00_axis_tvalid] [get_bd_pins sample_concatenation_3/s01_axis_tvalid]
  connect_bd_net -net dac_control_1 [get_bd_pins adc_control] [get_bd_pins control_switch0/adc_control]
  connect_bd_net -net s00_axi_aclk_1 [get_bd_pins s00_axi_aclk] [get_bd_pins bit_slicer_0/s00_axi_aclk] [get_bd_pins bit_slicer_1/s00_axi_aclk] [get_bd_pins bit_slicer_2/s00_axi_aclk] [get_bd_pins bit_slicer_3/s00_axi_aclk]
  connect_bd_net -net s00_axi_aresetn_1 [get_bd_pins s00_axi_aresetn] [get_bd_pins bit_slicer_0/s00_axi_aresetn] [get_bd_pins bit_slicer_1/s00_axi_aresetn] [get_bd_pins bit_slicer_2/s00_axi_aresetn] [get_bd_pins bit_slicer_3/s00_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_2_M04_AXI [get_bd_intf_pins axi_interconnect_2/M04_AXI] [get_bd_intf_pins tx_datapath/S00_AXI4]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_2_M10_AXI [get_bd_intf_pins SPB_blocks/S00_AXI] [get_bd_intf_pins axi_interconnect_2/M10_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_2_M13_AXI [get_bd_intf_pins SPB_blocks/S00_AXI5] [get_bd_intf_pins axi_interconnect_2/M13_AXI]
  ...
  connect_bd_net -net adc_tile0_o_INC_BP_2 [get_bd_ports o_INC_BP_0] [get_bd_ports o_INC_BP_1] [get_bd_ports o_INC_BP_2] [get_bd_ports o_INC_BP_3]
  connect_bd_net -net adc_tile0_o_RST_BP_2 [get_bd_ports o_RST_BP_0] [get_bd_ports o_RST_BP_1] [get_bd_ports o_RST_BP_2] [get_bd_ports o_RST_BP_3]
  connect_bd_net -net adc_tile0_o_RTN_BP_2 [get_bd_ports o_RTN_BP_0] [get_bd_ports o_RTN_BP_1] [get_bd_ports o_RTN_BP_2] [get_bd_ports o_RTN_BP_3]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xB000C000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SPB_blocks/bit_slicer_0/S00_AXI/S00_AXI_reg] SEG_bit_slicer_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0xB000E000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SPB_blocks/bit_slicer_1/S00_AXI/S00_AXI_reg] SEG_bit_slicer_1_S00_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0xB000F000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SPB_blocks/bit_slicer_2/S00_AXI/S00_AXI_reg] SEG_bit_slicer_2_S00_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0xB0011000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SPB_blocks/bit_slicer_3/S00_AXI/S00_AXI_reg] SEG_bit_slicer_3_S00_AXI_reg
