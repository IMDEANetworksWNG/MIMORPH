...
entity bit_slicer is
	...
	port (
		...
		m00_axis_tdata	: out std_logic_vector(sampleSize*8-1 downto 0);
...
begin
    ...
    i_5bits: if sampleSize = 5 generate
        process(aclk)
    begin
        if(rising_edge(aclk)) then
    ...
    i_10bits: if sampleSize = 10 generate
    process(aclk)
    begin
        if(rising_edge(aclk)) then
                ...
                for I in 0 to NUM_SAMPLES-1 loop
                        case SEL is
                            when 0 => m00_axis_tdata((I+1)*sampleSize-1 downto I*sampleSize)	<= s00_axis_tdata(I*16+9+0 downto I*16);
                            when 1 => m00_axis_tdata((I+1)*sampleSize-1 downto I*sampleSize)	<= s00_axis_tdata(I*16+9+1 downto I*16+1);
                            when 2 => m00_axis_tdata((I+1)*sampleSize-1 downto I*sampleSize)	<= s00_axis_tdata(I*16+9+2 downto I*16+2);
                            when 3 => m00_axis_tdata((I+1)*sampleSize-1 downto I*sampleSize)	<= s00_axis_tdata(I*16+9+3 downto I*16+3);
                            when 4 => m00_axis_tdata((I+1)*sampleSize-1 downto I*sampleSize)	<= s00_axis_tdata(I*16+9+4 downto I*16+4);
                            when 5 => m00_axis_tdata((I+1)*sampleSize-1 downto I*sampleSize)	<= s00_axis_tdata(I*16+9+5 downto I*16+5);
                            when 6 => m00_axis_tdata((I+1)*sampleSize-1 downto I*sampleSize)    <= s00_axis_tdata(I*16+9+6 downto I*16+6);
                            when 7 => m00_axis_tdata((I+1)*sampleSize-1 downto I*sampleSize)	<= s00_axis_tdata(I*16+9+7 downto I*16+7);
                            when others => m00_axis_tdata((I+1)*sampleSize-1 downto I*sampleSize)	<= s00_axis_tdata(I*16+4+11 downto I*16+11);
                        end case;
                end loop;                   
          end if;
